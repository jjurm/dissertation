...
Python code for generating charts for this report, and SQL code for extracting the data from the database, is kept with the LaTeX sources of this dissertation.
...
\todo{add brief description, or remove completely}
