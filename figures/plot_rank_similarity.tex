\begin{figure}
    ...
    The three chosen metrics \texttt{Degree}, \texttt{Betweenness} and \texttt{Redundancy}, demonstrate that values obtained by \graffs closely match those from The Paper.}
