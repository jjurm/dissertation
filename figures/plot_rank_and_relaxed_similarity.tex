\afterpage{%
    \begin{savenotes}%
        \begin{figure}[H]
            ...
            \begin{enumerate}
                \item[(a)] \scalepaperplots{\includegraphics{plot_rank_similarity_papertop.pdf}}\\
                \vspace*{-0.2cm}%
                \squashpaperplots{\includegraphics{plot_rank_similarity_paper_degree.pdf}\hspace*{0.1mm}\includegraphics{plot_rank_similarity_paper_betweenness.pdf}\hspace*{-0.4mm}\includegraphics{plot_rank_similarity_paper_redundancy.pdf}}\\
                \scalepaperplots{\includegraphics{plot_rank_similarity_paperbottom.pdf}}
                \vspace*{-0.7cm}
                \item[(b)] \hspace*{-0.25cm}\includegraphics[align=t,width=\linewidth]{plot_rank_similarity_graffs.pdf}
            \end{enumerate}
            \vspace{-0.4cm}
...
%\footnotetext{\label{foot:similarity_coefficients}Chosen according to \url{https://github.com/lbozhilova/measuring_rank_robustness/blob/master/figure_generation.R#L28}}
            \begin{enumerate}
                \item[(a)] \scalepaperplots{\includegraphics{plot_relaxed_similarity_papertop.pdf}}\\
                \vspace*{-0.2cm}%
                \squashpaperplots{\includegraphics[trim={0 0.8mm 0 0},clip]{plot_relaxed_similarity_paper_degree.pdf}\hspace*{0.2mm}\includegraphics[trim={0 0.3mm 0 0},clip]{plot_relaxed_similarity_paper_betweenness.pdf}\hspace*{-0.45mm}\includegraphics[trim={0 0.8mm 0 0},clip]{plot_relaxed_similarity_paper_localc.pdf}}\\
                \scalepaperplots{\includegraphics{plot_relaxed_similarity_paperbottom.pdf}}
                \vspace*{-0.7cm}
